#!/usr/bin/env bash
# Builds a standalone Linux executable (app-image) for the demo-rest module using jpackage.
...
APP_NAME="JfxSpringBootRest"
APP_VERSION="0.0.1"
MAIN_CLASS="com.example.jfx.spring.MainApplication"
JAR_NAME="jfx-spring-boot-rest-0.0.1-SNAPSHOT.jar"
