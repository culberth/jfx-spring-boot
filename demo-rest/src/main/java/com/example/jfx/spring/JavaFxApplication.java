...
public class JavaFxApplication extends Application
{
    ...
    public void init()
    {
        // SERVLET (not NONE, unlike the plain demo module) so the app can host the
        // REST endpoint that the FXML controllers call into to switch stages.
        applicationContext = new SpringApplicationBuilder().web(SERVLET).sources(MainApplication.class)
